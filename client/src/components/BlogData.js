...
const data = [
    {
        id: "DafriGroup Plc Announced Its Digital Banking Ambition; DafriBank, A sustainable platform for all digital problems.",
    ...
    {
        id: "DafriBank Limited Appoints a New Chief Executive Officer",
    ...
    {
        id: "UMEH Group Donates R500000.00 to COVID- 19 Solidarity Response Fund",
    ...
    {
        id: "DAFRIBANK DONATES N100 MILLION TO EDUCATIONAL INITIATIVE IN NIGERIA",
