...
const About = () => {
    return (<section id="go" >
        <MetaDecorator title="DafriGroup PLC - Leadership" description="Deeply rooted in our employees are our values, which drive us towards a common sense of purpose to create long lasting value for our stakeholders." />
            ...
            <div className={styles.leadership}>
                ...
                <div className={styles.details}>
                    ...
                    <p>
                        ...
                        <br/><br/><Link to='/leadership/xolane'>Read more...</Link>
                        </p>
